...
class Presets(object):
    START_TEXT = """
𝙃𝙚𝙡𝙡𝙤... {}
𝗜 𝗰𝗮𝗻 𝗰𝗹𝗼𝗻𝗲 𝗺𝗲𝗱𝗶𝗮 𝗳𝗿𝗼𝗺 𝗮𝗻𝘆 𝗰𝗵𝗮𝘁 𝘁𝗼 𝘆𝗼𝘂𝗿 𝗽𝗲𝗿𝘀𝗼𝗻𝗮𝗹 𝗰𝗵𝗮𝘁! 𝗖𝗹𝗶𝗰𝗸 𝘀𝗲𝘁𝘁𝗶𝗻𝗴𝘀 𝗯𝘂𝘁𝘁𝗼𝗻 𝘁𝗼 𝗰𝗼𝗻𝗳𝗶𝗴𝘂𝗿𝗲 𝗺𝗲. 𝗜𝗳 𝘆𝗼𝘂 𝗹𝗶𝗸𝗲 𝗺𝗲 𝗝𝗼𝗶𝗻 𝗮𝗻𝗱 𝘀𝘂𝗽𝗽𝗼𝗿𝘁 𝘂𝘀 @SDFBots
    """
...
𝐓𝐲𝐩𝐞𝐬: 📚:{} | 🎞:{} | 🔊:{} | 📸:{} | 🗣:{}
    ...
    COPIED_MESSAGES = "<b><a href='https://t.me/SDFCloneItBot'>Medias Copied</a></b>"
    IN_CORRECT_PERMISSIONS_MESSAGE_DEST_POSTING = "Access Denied\n\n𝘜𝘴𝘦𝘳 𝘪𝘴 𝘯𝘰𝘵 𝘢𝘯 𝘢𝘥𝘮𝘪𝘯 𝘰𝘳 𝘥𝘰𝘦𝘴𝘯'𝘵 𝘩𝘢𝘷𝘦\n" \
                                                  "𝘱𝘰𝘴𝘵𝘪𝘯𝘨 𝘱𝘳𝘪𝘷𝘪𝘭𝘢𝘨𝘦𝘴 𝘪𝘯 𝘵𝘩𝘦 𝘨𝘪𝘷𝘦𝘯 𝘤𝘩𝘢𝘵"
    USER_ABSENT_MSG = "𝙎𝙚𝙨𝙨𝙞𝙤𝙣 𝙪𝙨𝙚𝙧 𝙞𝙨 𝙣𝙤𝙩 𝙞𝙣 𝙩𝙝𝙚 𝙩𝙖𝙧𝙜𝙚𝙩 𝙘𝙝𝙖𝙩 𝙜𝙞𝙫𝙚𝙣 \n __ Add __ @SDF_2000 __in target chat and make admin to clone files__"
...
used in this bot if you know
just leave it, If you don't know
click on terminate button to 
block the session.
    """
